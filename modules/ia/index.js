...
async function chamarIA({ systemPrompt, userPrompt, maxTokens = 1000, temperatura = 0.1, modeloGroq = 'llama-3.1-8b-instant' }, logFn = noop) {
  try {
...
async function verificarSeCurriculo(texto, logFn = noop) {
  try {
...
async function traduzirSeNecessario(texto, logFn = noop) {
  try {
...
async function analisarComRetry(texto, logFn = noop) {
