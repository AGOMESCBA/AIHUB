...
process.env.IAC_NLSQL_DISABLE_SEMANTIC_DATASET = '1';
...
const PERGUNTAS = [
  'Qual foi o total de compras de junho do ano passado?',
  'Agora detalhe por fornecedor.',
  ...
  for (const pergunta of PERGUNTAS) {
    ...
    resultados.push({
      ...
      logs: logs.map(log => ({
        ...
        sql_auditoria_json: limparTexto(log.sql_auditoria_json, 12000),
