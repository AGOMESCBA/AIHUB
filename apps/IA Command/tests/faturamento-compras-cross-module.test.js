...
SET ROWCOUNT 50000;
SELECT
  COALESCE((SELECT SUM(SD1.D1_TOTAL) FROM SD1990 SD1 JOIN SF1990 SF1 ON SD1.D1_FILIAL = SF1.F1_FILIAL AND SD1.D1_DOC = SF1.F1_DOC AND SD1.D1_SERIE = SF1.F1_SERIE AND SD1.D1_FORNECE = SF1.F1_FORNECE AND SD1.D1_LOJA = SF1.F1_LOJA AND SF1.D_E_L_E_T_ = ' ' WHERE SD1.D_E_L_E_T_ = ' ' AND SF1.F1_TIPO IN ('N','C') AND SD1.D1_CF NOT LIKE '19%' AND SD1.D1_DTDIGIT BETWEEN '20250601' AND '20250630'), 0) AS total_compras_junho,
  COALESCE((SELECT SUM(SD1.D1_TOTAL) FROM SD1990 SD1 JOIN SF1990 SF1 ON SD1.D1_FILIAL = SF1.F1_FILIAL AND SD1.D1_DOC = SF1.F1_DOC AND SD1.D1_SERIE = SF1.F1_SERIE AND SD1.D1_FORNECE = SF1.F1_FORNECE AND SD1.D1_LOJA = SF1.F1_LOJA AND SF1.D_E_L_E_T_ = ' ' WHERE SD1.D_E_L_E_T_ = ' ' AND SF1.F1_TIPO IN ('N','C') AND SD1.D1_CF NOT LIKE '19%' AND SD1.D1_DTDIGIT BETWEEN '20250701' AND '20250731'), 0) AS total_compras_julho,
