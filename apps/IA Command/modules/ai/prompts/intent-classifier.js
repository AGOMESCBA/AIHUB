...
function buildPrompt(mensagem, intencoes = [], sinonimos = []) {
  ...
  const prompt = [
    ...
    '    "status": string|null',
    '  },',
    '  "agrupar_por": string|null,   // dimensão de agrupamento: "cliente", "produto", "vendedor", "fornecedor", "empresa" — preencher quando o usuário pede breakdown',
    ...
    'ultimos_N_dias (preencher dias) | comparacao_anual | comparacao_mensal | comparacao_mesmo_mes (preencher mes)',
...
module.exports = { buildPrompt, buildSynonymSection: _buildSynonymSection };
