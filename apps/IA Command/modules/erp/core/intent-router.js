...
const AI_SQL_HANDLERS = {
  compras: '../totvs_protheus/compras/ai-sql-handler-v2',
  financeiro: '../totvs_protheus/financeiro/ai-sql-handler-v2',
  faturamento: '../totvs_protheus/faturamento/ai-sql-handler-v2',
  comissao: '../totvs_protheus/comissao/ai-sql-handler-v2',
  estoque: '../totvs_protheus/estoque/ai-sql-handler-v2',
};
...
const SPEC_LOADERS = {
  ...
  financeiro:  () => require('../totvs_protheus/financeiro/financeiro-ia-owner-spec'),
  comissao:    () => require('../totvs_protheus/comissao/comissao-ia-owner-spec'),
  estoque:     () => require('../totvs_protheus/estoque/estoque-ia-owner-spec'),
};
...
const genericoSpec = require('../totvs_protheus/generico/generico-ia-owner-spec');
