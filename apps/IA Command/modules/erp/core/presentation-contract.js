...
const DIMENSIONS = [
  ...
  { canon: 'periodo_label', label: 'Periodo', aliases: ['periodo_label', 'label_periodo', 'rotulo_periodo'] },
  { canon: 'periodo_inicio', label: 'Periodo Inicio', aliases: ['periodo_inicio', 'inicio_periodo', 'data_inicio_periodo'] },
  { canon: 'semana_inicio', label: 'Semana Inicio', aliases: ['semana_inicio'] },
  { canon: 'semana_fim', label: 'Semana Fim', aliases: ['semana_fim', 'semana_fim_sexta'] },
  { canon: 'periodo_fim', label: 'Periodo Fim', aliases: ['periodo_fim', 'fim_periodo', 'data_fim_periodo'] },
  { canon: 'semana', label: 'Semana', aliases: ['semana', 'numero_semana', 'semana_numero', 'semana_mes'] },
  { canon: 'quinzena', label: 'Quinzena', aliases: ['quinzena', 'numero_quinzena', 'quinzena_mes'] },
  { canon: 'dezena', label: 'Dezena', aliases: ['dezena', 'numero_dezena', 'dezena_mes'] },
  ...
  { canon: 'tipo', label: 'Tipo', aliases: ['tipo', 'e1_tipo', 'e2_tipo'] },
  { canon: 'loja', label: 'Loja', aliases: ['loja', 'e1_loja', 'e2_loja'] },
  { canon: 'natureza', label: 'Natureza', aliases: ['natureza', 'naturez', 'e1_naturez', 'e2_naturez'] },
...
const METRICS = [
  ...
  { canon: 'valor_acumulado', label: 'Total Acumulado', type: 'money', totalRule: 'last', aliases: ['total_acumulado', 'valor_acumulado', 'vendas_acumuladas', 'faturamento_acumulado'] },
