...
- REGRA CRITICA - dono semantico das metricas: em contexto cross-module, cada alias de saida deve nascer do modulo correto. Aliases de faturamento (total_faturamento, faturamento, valor_faturamento, receita) representam nota fiscal de SAIDA e devem usar SF2.F2_VALBRUT quando nao houver detalhe de item, ou SD2.D2_TOTAL quando houver produto/item/quantidade. Aliases de compras (total_compras, compras, valor_compra, valor_compras) representam nota fiscal de ENTRADA e devem usar SD1.D1_TOTAL ou, sem SD1, SF1.F1_VALBRUT.
- REGRA CRITICA - SF1/SD1 nao sao faturamento normal: SF1 e SD1 pertencem ao caminho de notas de ENTRADA. Em uma consulta de faturamento bruto/normal, e PROIBIDO calcular total_faturamento com SF1.F1_VALBRUT, SF1.F1_TOTALNF, SF1.F1_VALMERC ou SD1.D1_TOTAL. SF1/SD1 so entram no modulo Faturamento para DEVOLUCAO DE VENDA, com SF1.F1_TIPO = 'D', projetando aliases de devolucao (total_devolucoes, valor_devolucao), nunca como total_faturamento bruto.
- REGRA CRITICA - comparativo compras x faturamento: para perguntas como "total das compras e do faturamento de junho/2026 comparando com junho/2025", gere metricas independentes por modulo: compras = SD1/SF1 filtrado por SD1.D1_DTDIGIT; faturamento = SF2 filtrado por SF2.F2_EMISSAO. Nunca reutilize SF1/SD1 para as duas metricas.
