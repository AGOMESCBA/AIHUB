...
- REGRA ABSOLUTA — se a pergunta pedir pedidos APROVADOS/LIBERADOS "por aprovador", "nome do aprovador" ou "quem aprovou", a SQL deve nascer a partir de SCR ou juntar SCR ja com ESTES filtros obrigatorios: SCR.CR_TIPO = 'PC' AND SCR.CR_STATUS = '03' AND SCR.D_E_L_E_T_ = ' '. PROIBIDO fazer LEFT JOIN SCR somente por numero/filial e deixar CR_TIPO/CR_STATUS para depois ou omitir esses filtros — isso mistura outros documentos/status e o validador bloqueara a consulta.
- REGRA ABSOLUTA — em pedidos APROVADOS/LIBERADOS por periodo, o periodo de aprovacao e SCR.CR_DATALIB (data da liberacao). Se o usuario tambem pedir "por dia", o alias dia deve representar SCR.CR_DATALIB, nao SC7.C7_EMISSAO; SC7.C7_EMISSAO e apenas a data de emissao do pedido.
