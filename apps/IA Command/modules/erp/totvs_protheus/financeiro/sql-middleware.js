...
const TABELAS_SCHEMA_FINANCEIRO = new Set(['SE1', 'SE2', 'SE5', 'SE8', 'SA1', 'SA2', 'SA3', 'SA6', 'SED', 'FK1', 'FK2', 'FK5', 'FK6', 'FK7', 'FKA', 'FKB']);
...
function processar(sql, cfg = {}) {
  ...
  const foraSchema = [..._extrairTabelas(sql)].filter(t => !TABELAS_SCHEMA_FINANCEIRO.has(t));
  if (foraSchema.length) resultado.alertas.push(`Tabelas fora do schema financeiro: ${foraSchema.join(', ')}`);
...
module.exports = { processar, carregarConfig, _extrairTabelas, TABELAS_SCHEMA_FINANCEIRO };
