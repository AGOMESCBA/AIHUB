...
- Natureza financeira (categoria contabil do titulo, ex.: "compras", "servicos", "aluguel" — NAO tem relacao com PA/NDF): SE2.E2_NATUREZ -> SED.ED_CODIGO.
- REGRA ABSOLUTA — NDF/PA nunca representam saldo real em aberto: exclua SEMPRE SE2.E2_TIPO IN ('PA', 'NDF') das consultas de saldo/posicao/em aberto por padrao, no WHERE. PA (pagamento antecipado) e NDF (nota de debito fornecedor) sao movimentos de compensacao, nao obrigacoes reais futuras — misturá-los distorce o saldo real a pagar. So inclua PA ou NDF quando o usuario pedir EXPLICITAMENTE (ver secao "Antecipacoes PA/RA" e "Titulos especiais — NDF, NCC"). ATENCAO — NUNCA confunda com o campo acima: E2_TIPO identifica o TIPO DE MOVIMENTO do titulo (NM, PA, NDF, etc.); E2_NATUREZ e a categoria contabil (nao tem os valores 'PA'/'NDF'). O filtro de PA/NDF e SEMPRE em SE2.E2_TIPO, jamais em SE2.E2_NATUREZ.
